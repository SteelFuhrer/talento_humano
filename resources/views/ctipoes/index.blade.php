...
<div class="content" style="margin-left: 20px">
    <h2>Gestión de tipos de asistencias</h2>
    <div class="row">
        <div class="col-md-12">
            <div class="card card-outline card-primary">
                <div class="card-header">
                    <h3 class="card-title"><b>Listado de tipos de asistencias</b></h3>
                    <div class="card-tools">
                    <a href="{{ route('ctipoes.create') }}" class="btn btn-success btn-sm" title="Nuevo Registro"><i class="fa-solid fa-circle-plus"></i> Nuevo</a>
                    </div>
                </div>
                <div class="card-body">
