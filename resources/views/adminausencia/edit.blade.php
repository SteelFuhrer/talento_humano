...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <h1 class="text-center mb-4">Editar Solicitud de Ausencia</h1>
            <form action="{{ route('adminausencia.update', $empleadoAusencia->IdEmpleadoAusencia) }}" method="POST">
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="estado" name="estado" required>
                        <option value="1" {{ $empleadoAusencia->estado == 1 ? 'selected' : '' }}>Aprobada</option>
                        <option value="0" {{ $empleadoAusencia->estado == 0 ? 'selected' : '' }}>No Aprobada</option>
                    </select>
                </div>
